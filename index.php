...
<head>
    ...
    <title>Furious Chat</title>
                <!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-2M91XREHWZ"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-2M91XREHWZ');
</script>
...
<body>
    <div class="container">
        ...
        <div class="left-list info">
            ...
            <div style="float: left;">
                <img id="usr_img" src="https://sudao.site/noxy.png" style="border-radius: 50%; width: 50px; margin-right: 15px; float: left; margin-top: 8px; margin-left: 5px;">
    ...
    <script>    
        ...
        function resetImg() {
            $.post("api/avatar.php", { 'user': localStorage["user"], 'img': 'https://sudao.site/noxy.png' });
